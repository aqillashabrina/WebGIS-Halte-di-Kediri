...
map.getView().fit([12458053.431415, -878075.922558, 12474399.370540, -870295.080688], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WebGIS Service Area Kediri</h2>';
        return titleElement;
    })(),
