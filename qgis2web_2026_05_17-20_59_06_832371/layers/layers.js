...
var lyr_Halte_1 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Halte<br />\
    <img src="styles/legend/Halte_1_0.png" /> Halte Ahmad Dahlan<br />\
    <img src="styles/legend/Halte_1_1.png" /> Halte Imam Bonjol<br />\
    <img src="styles/legend/Halte_1_2.png" /> Halte Permata Hijau<br />\
    <img src="styles/legend/Halte_1_3.png" /> Halte Semampir<br />\
    <img src="styles/legend/Halte_1_4.png" /> Halte Semeru<br />\
    <img src="styles/legend/Halte_1_5.png" /> <br />' });
...
lyr_Positron_0.setVisible(true);lyr_Halte_1.setVisible(true);lyr_ServiceArea_2.setVisible(true);
var layersList = [lyr_Positron_0,lyr_Halte_1,lyr_ServiceArea_2];
lyr_Halte_1.set('fieldAliases', {'fid': 'fid', 'OBJECTID': 'OBJECTID', 'Nama': 'Nama', 'REMARK': 'REMARK', 'ID': 'ID', 'Foto': 'Foto', });
...
lyr_Halte_1.set('fieldImages', {'fid': 'Hidden', 'OBJECTID': 'Hidden', 'Nama': 'TextEdit', 'REMARK': 'Hidden', 'ID': 'Hidden', 'Foto': 'TextEdit', });
...
lyr_Halte_1.set('fieldLabels', {'Nama': 'inline label - always visible', 'Foto': 'inline label - always visible', });
